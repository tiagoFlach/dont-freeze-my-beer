            ...
            <CardContent className="space-y-5">
                ...
                <ul className="space-y-1.5 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                        <code className="font-mono font-semibold text-foreground shrink-0">T(t)</code>
                        <span>— {t(language, "formulaDescriptionT").replace("T(t) = ", "")}</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <code className="font-mono font-semibold text-foreground shrink-0">T<sub>s</sub></code>
                        <span>— {language === "pt" ? "Temperatura ambiente (geladeira/freezer)" : language === "es" ? "Temperatura ambiente (nevera/congelador)" : "Ambient temperature (fridge/freezer)"}</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <code className="font-mono font-semibold text-foreground shrink-0">T<sub>0</sub></code>
                        <span>— {language === "pt" ? "Temperatura inicial da bebida" : language === "es" ? "Temperatura inicial de la bebida" : "Initial temperature of the drink"}</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <code className="font-mono font-semibold text-foreground shrink-0">k</code>
                        <span>— {t(language, "formulaDescriptionTk").replace("k = ", "")}</span>
                    </li>
                    <li className="flex items-start gap-2">
                        <code className="font-mono font-semibold text-foreground shrink-0">t</code>
                        <span>— {language === "pt" ? "Tempo decorrido (minutos)" : language === "es" ? "Tiempo transcurrido (minutos)" : "Time elapsed (minutes)"}</span>
                    </li>
                </ul>
